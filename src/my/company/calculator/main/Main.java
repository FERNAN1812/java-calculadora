...
import my.company.calculator.validacao.ValidacaoNumeroInteiro;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            opcaoNovocalculo = lerInteiroValido("Escolha");
        } while (opcaoNovocalculo != 2);
        System.out.println("Muinto obrigado por usar a Calculadora 2.3!");
